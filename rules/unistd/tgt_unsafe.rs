...
unsafe fn f3(a0: i32, a1: *mut ::libc::c_void, a2: usize) -> i64 {
    libc::read(a0, a1, a2) as i64
}
...
unsafe fn f10(a0: i32, a1: *const ::libc::c_void, a2: usize) -> i64 {
    libc::write(a0, a1, a2) as i64
}
