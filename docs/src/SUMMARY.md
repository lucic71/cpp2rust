...
- [Expressions](./codegen/expressions.md)
  - [Expression Kinds and Freshness](./codegen/expressions/kinds.md)
  - [Variable References](./codegen/expressions/variables.md)
  - [Pending Dereferences](./codegen/expressions/pending-deref.md)
  - [Literals](./codegen/expressions/literals.md)
  - [Operators](./codegen/expressions/operators.md)
  - [Calls](./codegen/expressions/calls.md)
  - [Temporary Materialization](./codegen/expressions/temporaries.md)
  - [Applying Rules](./codegen/expressions/rules.md)
  - [Translation Plugins](./codegen/expressions/plugins.md)
  - [Variadic Functions](./codegen/expressions/variadic.md)
  - [printf and Streams](./codegen/expressions/io.md)
