...
fn main_0() -> i32 {
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"42");
    assert!(
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"  -17abc");
    assert!(
        ((((((libcc2rs::strtoll_refcount((*s.borrow()).clone(), (end.as_pointer()).clone(), 10)
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"0xff");
    assert!(
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"0755");
    assert!(
        ((((((libcc2rs::strtoll_refcount((*s.borrow()).clone(), (end.as_pointer()).clone(), 0)
            == 493_i64) as i32)
            != 0)
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"0x");
    assert!(
        ((((((libcc2rs::strtoll_refcount((*s.borrow()).clone(), (end.as_pointer()).clone(), 16)
            == 0_i64) as i32)
            != 0)
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"9223372036854775808");
    assert!(
        ((((((libcc2rs::strtoll_refcount((*s.borrow()).clone(), (end.as_pointer()).clone(), 10)
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"-9223372036854775809");
    assert!(
        ((((((libcc2rs::strtoll_refcount((*s.borrow()).clone(), (end.as_pointer()).clone(), 10)
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"junk");
    assert!(
        ((((((libcc2rs::strtoll_refcount((*s.borrow()).clone(), (end.as_pointer()).clone(), 10)
            == 0_i64) as i32)
            != 0)
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"z");
    assert!(
    ...
    assert!(
        (((libcc2rs::strtoll_refcount(
            Ptr::from_string_literal(b"55").clone(),
            Ptr::<Ptr::<u8>>::null().clone(),
            10
        ) == 55_i64) as i32)
            != 0)
    );
    (*s.borrow_mut()) = Ptr::from_string_literal(b"3.14");
    assert!(
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"  -2.5e3xyz");
    assert!(
        ((((((libcc2rs::strtod_refcount((*s.borrow()).clone(), (end.as_pointer()).clone())
            == -2.5E+3) as i32)
            != 0)
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"1.e5");
    assert!(
        ((((((libcc2rs::strtod_refcount((*s.borrow()).clone(), (end.as_pointer()).clone())
            == 1.0E+5) as i32)
            != 0)
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b".5");
    assert!(
        ((((((libcc2rs::strtod_refcount((*s.borrow()).clone(), (end.as_pointer()).clone())
            == 5.0E-1) as i32)
            != 0)
    ...
    (*s.borrow_mut()) = Ptr::from_string_literal(b"1e");
    assert!(
        ((((((libcc2rs::strtod_refcount((*s.borrow()).clone(), (end.as_pointer()).clone())
            == 1.0E+0) as i32)
            != 0)
    ...
    assert!(
        (((libcc2rs::strtod_refcount(
            Ptr::from_string_literal(b"+0.375e-1").clone(),
            Ptr::<Ptr::<u8>>::null().clone()
        ) == 3.75E-2) as i32)
            != 0)
    );
