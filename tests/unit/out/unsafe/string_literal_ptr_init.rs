...
unsafe fn main_0() -> i32 {
    assert!(
        (((((*table_1[((0) as usize)].name.offset(((0) as isize))) as i32) == ('f' as i32))
            as i32)
            != 0)
    );
    assert!(
        (((((*table_1[((0) as usize)].name.offset(((4) as isize))) as i32) == ('t' as i32))
            as i32)
            != 0)
    );
    ...
    assert!(
        (((((*table_1[((1) as usize)].name.offset(((0) as isize))) as i32) == ('s' as i32))
            as i32)
            != 0)
    );
