...
unsafe fn main_0() -> i32 {
    ...
    (unsafe { decay_cast_0((&raw mut a1[((0) as usize)] as *mut u32)) });
    (unsafe { bit_cast_1(((a1.as_mut_ptr() as *const u32) as *const ::libc::c_void)) });
    (unsafe {
        bit_cast_1(
            (((&raw mut a1[((0) as usize)] as *mut u32) as *const u32) as *const ::libc::c_void),
        )
    });
    (unsafe {
        bit_cast_1((((&raw mut a1 as *mut [u32; 3]) as *const [u32; 3]) as *const ::libc::c_void))
    });
