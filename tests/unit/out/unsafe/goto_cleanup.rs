...
unsafe fn main_0() -> i32 {
    ...
    let mut w: wrapper = wrapper {
        item: (&raw mut value as *mut i32),
    };
    assert!(((((unsafe { via_pointer_3((&raw mut w as *mut wrapper), 0) }) == (42)) as i32) != 0));
    assert!(
        ((((unsafe { via_pointer_3((&raw mut w as *mut wrapper), 1) }) == (-1_i32)) as i32) != 0)
    );
